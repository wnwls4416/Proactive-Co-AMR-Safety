...
class PC3Stage12Node(Node):
    def __init__(self):
        ...
        self.create_subscription(Int32, '/signal_web1_class', self.class_callback, self.qos)
        self.create_subscription(Int32, '/signal_web1_section', self.section_callback, self.qos)
