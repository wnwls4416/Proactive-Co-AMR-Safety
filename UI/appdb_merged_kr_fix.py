...
5. 두 가지 HTML 버전 지원:
   ...
   - dashboard_v8b_modal.html: 영상 클릭 시 확대 보기 기능 포함
...
- dashboard_v8b_modal.html: 확대 기능 포함 버전 (영상 클릭 시 모달)
...
def dashboard():
    ...
    - modal: dashboard_v8b_modal.html (영상 확대 기능)
    """
    # HTML 파일명 결정
    if HTML_VERSION == "modal":
        html_filename = "dashboard_v8b_modal.html"
    else:
